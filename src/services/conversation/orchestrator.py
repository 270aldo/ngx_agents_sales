        ...
        try:
            ...
            if self.ml_pipeline:
                await self.ml_pipeline.record_outcome(
                    ...
                    outcome_value=outcome_metrics.get("conversion_value", 0),
                    metrics=outcome_metrics
                )
                
                # Trigger feedback loop for model improvement
            ...
            # Record outcome in ML Pipeline for feedback loop
            if self.ml_pipeline:
                try:
    ...
    async def _init_predictive_services(self) -> None:
        ...
        try:
            ...
            if not self.decision_engine and self.objection_predictor and self.needs_predictor and self.conversion_predictor:
                ...
                logger.info("DecisionEngineService initialized")
