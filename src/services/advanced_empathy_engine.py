...
class AdvancedEmpathyEngine:
    ...
    def _initialize_micro_detections(self) -> Dict[str, List[str]]:
        ...
        return {
            "hesitation": ["bueno...", "este...", "mmm", "no sé si", "tal vez", "quizás", "es que", "pues", "verás", "lo que pasa es que"],
            "urgency": ["ya", "ahora", "urgente", "rápido", "necesito", "cuanto antes", "inmediatamente", "no puedo esperar", "es urgente", "lo antes posible"],
            "doubt": ["pero", "aunque", "sin embargo", "no estoy seguro", "será que", "dudo que", "no sé qué pensar", "me cuestiono", "tengo dudas"],
            "interest": ["cuéntame", "dime más", "interesante", "wow", "ah sí?", "en serio?", "me llama la atención", "quisiera saber", "explícame", "eso suena bien"],
            "commitment": ["definitivamente", "absolutamente", "sin duda", "claro que sí", "por supuesto", "estoy listo", "vamos a hacerlo", "cuenta conmigo", "me comprometo"],
            "resistance": ["no creo", "difícil", "complicado", "no puedo", "imposible", "no me convence", "tengo mis reservas", "no es para mí", "no funcionará"],
            "openness": ["podría", "me gustaría", "estaría bien", "suena bien", "veamos", "estoy abierto", "por qué no", "vamos a intentarlo", "me interesa explorar"],
            "fatigue": ["cansado", "agotado", "no tengo energía", "exhausto", "drenado", "sin fuerzas", "rendido", "no doy más", "estoy quemado", "burnout"],
            "hope": ["ojalá", "espero", "sería genial", "me encantaría", "sueño con", "anhelo", "deseo que", "aspiro a", "mi meta es", "visualizo"],
            "fear": ["miedo", "temo", "preocupa", "asusta", "nervioso", "ansiedad", "me da temor", "me inquieta", "me angustia", "me aterra"],
            "frustration": ["frustra", "harto", "molesto", "fastidiado", "irritado", "no aguanto", "estoy hasta", "me desespera", "no soporto"],
            "excitement": ["emocionado", "entusiasmado", "motivado", "con ganas", "listo para", "ansioso por", "no puedo esperar", "qué emocionante"],
            "overwhelm": ["abrumado", "sobrepasado", "demasiado", "no puedo con todo", "es mucho", "me supera", "no sé por dónde empezar"],
            "trust_building": ["confío", "me fío", "creo en", "tengo fe", "me da confianza", "me siento seguro", "me transmite"],
            "price_concern": ["caro", "precio", "costo", "inversión", "presupuesto", "económico", "cuánto", "vale la pena", "puedo pagar", "accesible"]
        }
