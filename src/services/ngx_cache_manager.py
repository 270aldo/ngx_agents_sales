...
class NGXCacheManager:
    ...
    TTL_CONVERSATION = 3600  # 60 minutes (was 30)
    TTL_CUSTOMER = 7200  # 2 hours (was 1)
    TTL_PREDICTION = 1800  # 30 minutes (was 5)
    TTL_TIER = 3600  # 60 minutes (was 30)
    TTL_PROGRAM = 7200  # 2 hours (was 1)
    TTL_ROI = 3600  # 60 minutes (was 10) - ROI doesn't change often
    TTL_CONFIG = 14400  # 4 hours (was 2)
    TTL_KNOWLEDGE = 172800  # 48 hours (was 24)
    TTL_PROMPT = 3600  # 60 minutes - NEW: Cache optimized prompts
    TTL_RESPONSE = 1800  # 30 minutes - NEW: Cache common responses
    TTL_EMOTIONAL = 900  # 15 minutes - NEW: Cache emotional profiles
