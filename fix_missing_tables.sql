-- Script para crear las 11 tablas faltantes en Supabase
...
CREATE INDEX idx_adaptive_learning_active ON adaptive_learning_config(is_active);
CREATE INDEX idx_learned_models_type ON learned_models(model_type);
CREATE INDEX idx_learned_models_champion ON learned_models(champion_model);
...
CREATE INDEX idx_conversation_outcomes_conversation ON conversation_outcomes(conversation_id);
CREATE INDEX idx_ab_test_variants_test ON ab_test_variants(test_name);
CREATE INDEX idx_ab_test_results_test ON ab_test_results(test_name, variant_name);
CREATE INDEX idx_pattern_recognitions_type ON pattern_recognitions(pattern_type);
CREATE INDEX idx_prompt_performance_variant ON prompt_performance(variant_id);
CREATE INDEX idx_tier_detections_conversation ON tier_detections(conversation_id);
